...
print("Loading model...")
model=ViTForImageClassification.from_pretrained(f"./outputs/{args.name}",num_labels=100,device_map="cuda",ignore_mismatched_sizes=True)
...
def evaluate_model(model, dataset):
    ...
    with open(f'./outputs/{args.name}/CIFAR100.tsv', "w", newline="") as f:
