...
print("Loading model...")
model=ViTForImageClassification.from_pretrained(f"./outputs/{args.name}",num_labels=101,device_map="cuda",ignore_mismatched_sizes=True)
...
def evaluate_model(model, dataset):
    ...
    with open(f'./outputs/{args.name}/FOOD101.tsv', "w", newline="") as f:
